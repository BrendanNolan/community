...
(preev | previous) statement:
 ...
 #   ["[[t"] = "@statement.outer",
 # select = {
select in assignment: user.make_selection("v", "i=")
(cut | destroy | delete) in assignment: user.make_selection("d", "i=")
copy in assignment: user.make_selection("y", "i=")
change in assignment: user.make_selection("c", "i=")
select left assignment: user.make_selection("v", "l=")
(cut | destroy | delete) left assignment: user.make_selection("d", "l=")
copy left assignment: user.make_selection("y", "l=")
change left assignment: user.make_selection("c", "l=")
select assignment: user.make_selection("v", "o=")
(cut | destroy | delete) assignment: user.make_selection("d", "o=")
copy assignment: user.make_selection("y", "o=")
change assignment: user.make_selection("c", "o=")
select right assignment: user.make_selection("v", "r=")
(cut | destroy | delete) right assignment: user.make_selection("d", "r=")
copy right assignment: user.make_selection("y", "r=")
change right assignment: user.make_selection("c", "r=")
...
select in function: user.make_selection("v", "if")
(cut | destroy | delete) in function: user.make_selection("d", "if")
copy in function: user.make_selection("y", "if")
change in function: user.make_selection("c", "if")
select around function: user.make_selection("v", "af")
(cut | destroy | delete) around function: user.make_selection("d", "af")
copy around function: user.make_selection("y", "af")
change around function: user.make_selection("c", "af")
